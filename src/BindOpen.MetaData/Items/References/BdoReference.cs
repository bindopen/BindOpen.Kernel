...
namespace BindOpen.MetaData.Items
{
    ...
    public class BdoReference : BdoItem, IBdoReference
    {
        ...
        /// </summary>
        public IBdoMetaElement SourceElement { get; set; }
        ...
        /// </summary>
        public IBdoMetaElement RootElement() => SourceElement?.ItemReference?.SourceElement;
        ...
        public override object Clone(params string[] areas)
        {
            ...
            dataReference.SourceElement = SourceElement.Clone<IBdoMetaElement>();
            dataReference.PathDetail = PathDetail.Clone<BdoMetaElementSet>();
