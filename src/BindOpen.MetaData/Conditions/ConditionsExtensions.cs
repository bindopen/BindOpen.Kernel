...
namespace BindOpen.MetaData.Conditions
{
    ...
    public static class ConditionsExtensions
    {
            ...
            IBdoMetaElementSet varElementSet)
        {
            ...
            {
                return advancedCondition.Evaluate(scriptInterpreter, varElementSet);
            }
            ...
            {
                return scriptCondition.Evaluate(scriptInterpreter, varElementSet);
            }
            ...
            foreach (var subCondition in condition.Conditions)
            {
                switch (condition.Kind)
                {
                    case AdvancedConditionKind.And:
                        b &= subCondition.Evaluate(scriptInterpreter, varElementSet);
                        break;
            ...
            IBdoMetaElementSet varElementSet)
        {
            ...
            var b = scriptInterpreter.Evaluate<bool?>(condition.Expression, varElementSet);
