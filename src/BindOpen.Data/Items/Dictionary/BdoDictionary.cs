...
namespace BindOpen.Data.Items
{
        ...
        IBdoDictionary
    {
        ...
        {
            var dictionary = BdoItems.NewDictionary();
        ...
        public bool Equals(IBdoDictionary dictionary)
        {
            if (dictionary == null || Values == null || dictionary.Values == null || Values.Count != dictionary.Values.Count)
            {
                return false;
            }
            ...
            {
                isEqual &= pair.Value == dictionary[pair.Key];
            }
