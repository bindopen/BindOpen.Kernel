...
namespace BindOpen.Data.Stores
{
    ...
    /// </summary>
    public class BdoDatasourceDepot : TBdoDepot<IBdoSource>, IBdoSourceDepot
    {
        // ------------------------------------------
        // CONSTRUCTORS
        // ------------------------------------------
        ...
        public override IBdoSource Get(string key = null)
        {
        ...
        {
            IBdoSource source = Get(sourceName);
        ...
        {
            IBdoSource dataSource = Get(sourceName);
