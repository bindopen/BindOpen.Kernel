...
namespace BindOpen.Data.Elements
{
    ...
    /// </summary>
    public abstract class TBdoElement<TElement, TSpec, TItem> : BdoElement,
        ITBdoElement<TElement, TSpec, TItem>
        ...
        where TItem : class
    {
        ...
        public new List<TSpec> Specs
        {
            ...
            set { base.WithSpecifications(value?.Cast<IBdoElementSpec>().ToArray()); }
        }
        ...
        /// <returns></returns>
        public new TElement WithSpecifications(params IBdoElementSpec[] specs)
        {
