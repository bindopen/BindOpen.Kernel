    ...
    public class NFSConnector : RepositoryConnector
    {
            ...
            ILog log = null)
        {
            ...
            try
            {
                ...
                System.IO.File.Copy(remoteFileUri, localPathUri, canOverwrite);
            }
            ...
            ILog log = null)
        {
            ...
            try
            {
                ...
                System.IO.File.Copy(localFileUri, remotePathUri, canOverwrite);
            }
            catch (Exception exception)
            {
            ...
            if (Directory.Exists(folderUri))
            {
                    ...
                    (fileKind == CarrierKind_standard.Any))
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            aRegex = new System.Text.RegularExpressions.Regex(filter);
                        }
                        catch
                        {
                    ...
                    (fileKind == CarrierKind_standard.Any))
                {
                    ...
                    foreach (DirectoryInfo directoryInfo in directoryInfos)
                    {
                        Boolean isFound = !isRegularExpression;
                        if (isRegularExpression & (aRegex != null))
                            isFound = aRegex.IsMatch(directoryInfo.Name);
            ...
            ILog log = null)
        {
            ...
            try
            {
                if (System.IO.File.Exists(localFileUri))
                {
                    System.IO.Directory.Delete(localFileUri, true);
            ...
            ILog log = null)
        {
            ...
            try
            {
                if (System.IO.Directory.Exists(localfolderUri))
                {
                    System.IO.Directory.Delete(localfolderUri, true);
