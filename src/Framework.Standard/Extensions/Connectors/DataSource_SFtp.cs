...
{
    /// <summary>
    /// This class represents a SFTP file data source.
    /// </summary>
    public class DataSource_SFtp : DataSource
    {
       // ---------------------------------
       // PROPERTIES
       // ---------------------------------
       ...
       #region Properties
        ...
        /// <summary>
        /// This instantiates a new instance of the DataSource_SFtp class.
        /// </summary>
        public DataSource_SFtp() 
            : this(null)
        {
        }
        ...
        public DataSource_SFtp(DataSource aDataSource)
        {
            this.ConnectorUniqueName = "standard$sftp";
