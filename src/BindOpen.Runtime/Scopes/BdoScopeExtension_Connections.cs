...
namespace BindOpen.Runtime.Scopes
{
    ...
    public static partial class BdoScopeExtension
    {
            ...
            where T : class, IBdoConnection
        {
            if (dataSource == null)
            ...
            else if (!string.IsNullOrEmpty(connectorDefinitionUniqueName) && dataSource.HasConfig(connectorDefinitionUniqueName))
                ...
                return scope.Open<T>(dataSource.GetConfig(connectorDefinitionUniqueName), log);
