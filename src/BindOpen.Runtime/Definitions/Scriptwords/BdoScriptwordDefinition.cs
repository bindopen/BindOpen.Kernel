...
namespace BindOpen.Runtime.Definitions
{
    ...
    /// </summary>
    public class BdoScriptwordDefinition : BdoExtensionDefinition, IBdoScriptwordDefinition
    {
        // ------------------------------------------
        // PROPERTIES
        // ------------------------------------------
        ...
        /// </summary>
        public IBdoSpecSet ParameterSpecification { get; set; }
        ...
        public BdoScriptwordDefinition(
            string name,
            IBdoPackageDefinition extensionDefinition) : base(name, "scriptWordDef_", extensionDefinition)
        {
        }
        ...
        public string GetRepeatedParameterDescriptionText(
