...
namespace BindOpen.MetaData.Elements
{
    ...
    /// </summary>
    [XmlType("MetaElementSpec", Namespace = "https://xsd.bindopen.org")]
    [XmlInclude(typeof(MetaCarrierSpecDto))]
    [XmlInclude(typeof(MetaObjectSpecDto))]
    [XmlInclude(typeof(MetaScalarSpecDto))]
    [XmlInclude(typeof(MetaSourceSpecDto))]
    public abstract class MetaElementSpecDto : DataSpecificationDto
    {
        // --------------------------------------------------
        // PROPERTIES
        // --------------------------------------------------
