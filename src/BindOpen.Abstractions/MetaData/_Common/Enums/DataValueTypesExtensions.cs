...
namespace BindOpen.MetaData
{
    ...
    public static class DataValueTypesExtensions
    {
        ...
        public static DataValueTypes GetValueType(this Type type)
        {
            ...
            else if (typeof(IBdoDataSource).IsAssignableFrom(type) || typeof(IBdoConnectorConfiguration).IsAssignableFrom(type))
                return DataValueTypes.Datasource;
            else if (typeof(IBdoMetaCollection).IsAssignableFrom(type))
