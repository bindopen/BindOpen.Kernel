...
namespace BindOpen.Scoping
{
    ...
    /// </summary>
    public abstract class ExtensionDefinitionDb : DefinitionDb
    {
        // --------------------------------------------------
        // PROPERTIES
        // --------------------------------------------------
        ...
        [XmlArray("groups")]
        [XmlArrayItem("group")]
        public List<ExtensionGroupDb> Groups { get; set; }
        ...
        /// <summary>
        /// Instantiates a new instance of the BdoExtensionDefinitionDb class.
        /// </summary>
        protected ExtensionDefinitionDb()
        {
        }
    }
