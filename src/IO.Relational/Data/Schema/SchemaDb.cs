...
/// </summary>
public class SchemaDb : IBdoDb, IIdentified
{
    // --------------------------------------------------
    // PROPERTIES
    // --------------------------------------------------
    ...
    public List<SchemaDb> Supers { get; set; }
    ...
    /// </summary>
    [ForeignKey(nameof(SchemaRuleDb.SchemaId))]
    public List<SchemaRuleDb> Rules { get; set; }

    /// <summary>
    /// THe children of this instance.
    /// </summary>
    [ForeignKey(nameof(ParentId))]
    public List<SchemaDb> Children { get; set; }
