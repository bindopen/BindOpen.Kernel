...
{
    /// <summary>
    /// This class represents an bot options.
    /// </summary>
    public abstract class BotOptions : DataItem, IBotOptions
    {
        // ------------------------------------------
        // CONSTANTS
        // ------------------------------------------
        ...
        /// </summary>
        public static readonly string __DefaultSettingsFileName = "bindopen.xml";
        ...
        /// The settings.
        /// </summary>
        public IBotSettings Settings { get; set; }
        ...
        public IBotOptions SetAppFolder(string appFolderPath)
        {
        ...
        /// <returns>Returns this instance.</returns>
        public IBotOptions SetRuntimeFolder(string runtimeFolderPath)
        {
        ...
        /// <returns>Returns this instance.</returns>
        public IBotOptions SetLibraryFolder(string libraryFolderPath)
        {
        ...
        /// <returns>Returns this instance.</returns>
        public IBotOptions SetModule(IAppModule module)
        {
        ...
        /// <returns>Returns this instance.</returns>
        public IBotOptions SetModule(string moduleName)
        {
        ...
        /// <returns>Returns this instance.</returns>
        public IBotOptions AddExtensions(IAppExtensionConfiguration extensionConfiguration)
        {
        ...
        /// <returns>Returns this instance.</returns>
        public IBotOptions AddExtensions(params IAppExtensionFilter[] filters)
        {
            if (filters != null)
            {
        ...
        /// <returns>Returns this instance.</returns>
        public virtual IBotOptions DefineDefaultSettings(IDataElementSpecSet specificationSet)
        {
            Settings = new DefaultBotSettings();
        ...
        /// <returns>Returns this instance.</returns>
        public IBotOptions AddLoggers(params ILogger[] loggers)
        {
        ...
        /// </summary>
        /// <returns>Returns this instance.</returns>
        public IBotOptions AddDefaultLogger()
        {
