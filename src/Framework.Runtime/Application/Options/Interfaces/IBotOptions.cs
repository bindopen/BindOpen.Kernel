...
{
    /// <summary>
    /// The interface defines the base BDO bot options.
    /// </summary>
    public interface IBotOptions
    {
        ...
        IBotOptions SetAppFolder(string appFolderPath);
        ...
        /// <returns>Returns the bot option.</returns>
        IBotOptions SetRuntimeFolder(string runtimeFolderPath);
        ...
        /// <returns>Returns the bot option.</returns>
        IBotOptions SetLibraryFolder(string libraryFolderPath);
        ...
        /// <param name="specificationSet">The set of data element specifcations to consider.</param>
        /// <returns>Returns the bot option.</returns>
        IBotOptions DefineDefaultSettings(IDataElementSpecSet specificationSet = null);
        ...
        /// <returns>Returns the bot option.</returns>
        IBotOptions AddExtensions(IAppExtensionConfiguration extensionConfiguration);
        ...
        /// <returns>Returns the bot option.</returns>
        IBotOptions AddExtensions(params IAppExtensionFilter[] filters);

        /// <summary>
        /// Adds the default logger.
        /// </summary>
        /// <returns>Returns the bot option.</returns>
        IBotOptions AddDefaultLogger();
        ...
        /// <returns>Returns the bot option.</returns>
        IBotOptions AddLoggers(params ILogger[] loggers);
        ...
        /// <returns>Returns the bot option.</returns>
        IBotOptions SetModule(IAppModule module);
        ...
        /// <returns>Returns the bot option.</returns>
        IBotOptions SetModule(string moduleName);
    }
}