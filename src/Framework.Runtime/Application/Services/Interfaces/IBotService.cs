...
namespace BindOpen.Framework.Runtime.Application.Services
{
    ...
    /// </summary>
    public interface IBotService : IBotScopedService
    {
        /// <summary>
        /// The loggers.
        /// </summary>
        ...
        /// </summary>
        event BotService.OnLoadCompletedEventHandler OnLoadCompleted;
        ...
        IBotService Start(ILog log = null);
        ...
        /// <returns>Returns the bot to consider.</returns>
        IBotService End(ProcessExecutionStatus executionStatus = ProcessExecutionStatus.Stopped);
