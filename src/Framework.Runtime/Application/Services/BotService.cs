...
namespace BindOpen.Framework.Runtime.Application.Services
{
    ...
    /// </summary>
    public abstract class BotService : BotScopedService, IBotService
    {
        // ------------------------------------------
        // VARIABLES
        // ------------------------------------------
        ...
        protected BotService(
            ...
            ILogger[] loggers = null) : base(scope)
        {
            Settings = settings;
        ...
        public virtual IBotService Start(ILog log = null)
        {
            log = log ?? new Log();
        ...
        public virtual IBotService End(ProcessExecutionStatus executionStatus = ProcessExecutionStatus.Stopped)
        {
        ...
        protected override ILog Initialize<A>()
        {
            ...
            _scope.Context.AddSystemItem("appHost", this);
            _scope.DataSourceDepot = new DataSourceDepot();
