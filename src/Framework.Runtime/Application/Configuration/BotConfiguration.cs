...
{
    /// <summary>
    /// This class represents a bot configuration.
    /// </summary>
    [XmlType("BotConfiguration", Namespace = "https://bindopen.org/xsd")]
    [XmlRoot("bot.config", Namespace = "https://bindopen.org/xsd", IsNullable = false)]
    public class BotConfiguration : Core.Application.Configuration.BaseConfiguration, IBotConfiguration
    {
        // -------------------------------------------------------
        // PROPERTIES
        // -------------------------------------------------------
        ...
        public BotConfiguration(params IDataElement[] items)
            : base(items)
        {
        }
            ...
            UpdateModes[] updateModes = null)
        {
            ...
            if (item is BotConfiguration configuration)
            {
