...
namespace BindOpen.Framework.Runtime.Application.Settings
{
    ...
    /// </summary>
    public class TBotSettings<Q> : TSettings<Q>, ITBotSettings<Q>
        where Q : class, IBotConfiguration, new()
    {
        ...
        /// </summary>
        public IBotConfiguration AppConfiguration => Configuration as IBotConfiguration;
        ...
        public TBotSettings(IAppScope appScope, Q configuration)
        ...
        /// </summary>
        /// <param name="appScope">The application scope to consider.</param>
        public void SetAppScope(IAppScope appScope)
        {
            _scope = appScope;
        }
