...
namespace BindOpen.Framework.Core.Data.Elements.Carrier
{
    ...
    /// </summary>
    [Serializable()]
    [XmlType("CarrierElementSpecification", Namespace = "http://meltingsoft.com/bindopen/xsd")]
    [XmlRoot(ElementName = "specification", Namespace = "http://meltingsoft.com/bindopen/xsd", IsNullable = false)]
    public class CarrierElementSpecification : DataElementSpecification
    {
        ...
        /// </summary>
        public CarrierElementSpecification(): base()
        {
        }
        ...
        public CarrierElementSpecification(
        ...
        {
            CarrierElementSpecification dataCarrierElementSpecification = base.Clone() as CarrierElementSpecification;
            if (this.DefinitionFilter!= null)
                dataCarrierElementSpecification.DefinitionFilter = this.DefinitionFilter.Clone() as DataValueFilter;
            return dataCarrierElementSpecification;
        }
