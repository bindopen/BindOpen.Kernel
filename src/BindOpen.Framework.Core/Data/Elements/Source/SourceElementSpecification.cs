...
namespace BindOpen.Framework.Core.Data.Elements.Source
{
    ...
    /// </summary>
    [Serializable()]
    [XmlType("SourceElementSpecification", Namespace = "http://meltingsoft.com/bindopen/xsd")]
    [XmlRoot(ElementName = "specification", Namespace = "http://meltingsoft.com/bindopen/xsd", IsNullable = false)]
    public class SourceElementSpecification : DataElementSpecification
    {
        ...
        /// </summary>
        public SourceElementSpecification(): this(AccessibilityLevel.Public)
        {
        }
        ...
        public SourceElementSpecification(
        ...
        {
            SourceElementSpecification dataSourceElementSpecification = base.Clone() as SourceElementSpecification;
            if (this.ConnectorFilter != null)
                dataSourceElementSpecification.ConnectorFilter = this.ConnectorFilter.Clone() as DataValueFilter;
            return dataSourceElementSpecification;
        }
