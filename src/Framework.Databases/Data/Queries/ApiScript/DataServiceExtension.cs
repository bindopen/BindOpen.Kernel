    ...
    public static partial class DataServiceExtension
    {
            ...
            IScriptVariableSet scriptVariableSet = null)
        {
            ...
            if (dataService?.Connection is DatabaseConnection connection)
            {
                ...
                else if (connection.Connector.QueryBuilder == null)
                {
                    log.AddError("Connector query builder missing");
                }
                else
                {
                    log.Append(
                        connection.Connector.QueryBuilder.BuildQuery(query, scriptVariableSet, out string sql));
