...
namespace BindOpen.Framework.Core.Extensions.Definition.Libraries
{
    ...
    /// </summary>
    /// <param name="extension">The application extension to consider.</param>
    ...
    public virtual ILog LoadLibraries(
        this IAppExtension extension,
            ...
            else
            {
                ...
                else
                {
                    ...
                    Library library = _appDomain.LoadLibrary(
                        ...
                        subLog,
                        extensionItemKinds,
                        new List<DataSourceKind>() { DataSourceKind.Memory });
    ...
    public static class LibraryDefinitionFactory
    {
            ...
            ILog log = null)
        {
            ...
            {
                //log.AddCheckpoint("Loading the '" + libraryItemKind.ToString() + "' index of the library '" + this.DefinitionUniqueId + "'");
            ...
            switch (extensionItemDefinition.GetExtensionItemKind())
            {
                ...
                case AppExtensionItemKind.Routine:
                    (extensionItemDefinition as RoutineDefinition).ItemClass = this.UpdateClassFullName(
                        (extensionItemDefinition as RoutineDefinition)?.ItemClass, AppExtensionItemKind.Routine);
                    type = assembly.GetType(LibraryDefinition.GetClassNameWithoutAssembly(
