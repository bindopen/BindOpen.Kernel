...
namespace BindOpen.Framework.Core.Extensions.Definitions.Handlers
{
    ...
    /// </summary>
    [Serializable()]
    [XmlType("HandlerDefinition", Namespace = "https://bindopen.org/xsd")]
    [XmlRoot(ElementName = "dataHandler.definition", Namespace = "https://bindopen.org/xsd", IsNullable = false)]
    public class HandlerDefinitionDto : AppExtensionItemDefinitionDto, IHandlerDefinitionDto
    {
        // --------------------------------------------------
        // PROPERTIES
        // --------------------------------------------------
