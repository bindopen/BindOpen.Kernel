...
namespace BindOpen.Framework.Core.Extensions.Definitions.Scriptwords
{
    ...
    /// </summary>
    [Serializable()]
    [XmlType("ScriptwordDefinition", Namespace = "https://bindopen.org/xsd")]
    [XmlRoot(ElementName = "scriptWord.definition", Namespace = "https://bindopen.org/xsd", IsNullable = false)]
    public class ScriptwordDefinitionDto : AppExtensionItemDefinitionDto, IScriptwordDefinitionDto
    {
        // ------------------------------------------
        // VARIABLES
        // ------------------------------------------
        ...
        private List<ScriptwordDefinitionDto> _children = null;
        ...
        public List<ScriptwordDefinitionDto> Children
        {
            get {
                return this._children ?? (this._children = new List<ScriptwordDefinitionDto>());
            }
            set {
        ...
        /// </summary>
        public ScriptwordDefinitionDto()
        {
        }
