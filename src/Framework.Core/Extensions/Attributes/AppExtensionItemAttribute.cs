...
namespace BindOpen.Framework.Core.Extensions.Attributes
{
    ...
    public class AppExtensionItemAttribute : Attribute
    {
        // ------------------------------------------
        // PROPERTIES
        // ------------------------------------------
        ...
        /// <summary>
        /// Instantiates a new instance of the AppExtensionItemAttribute class.
        /// </summary>
        public AppExtensionItemAttribute() : base()
        {
        }
