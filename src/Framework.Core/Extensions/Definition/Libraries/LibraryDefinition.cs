...
namespace BindOpen.Framework.Core.Extensions.Definition.Libraries
{
    ...
    public class LibraryDefinition : DescribedDataItem, ILibraryDefinition
    {
        // ------------------------------------------
        // CONSTANTS
        // ------------------------------------------
        ...
        private const string __DefaultResourceFileName = "Library.Definition";
        ...
        private IDictionaryDataItem _itemIndexFullNameDictionary = null;
        ...
        /// </summary>
        [XmlElement("indexes")]
        public IDictionaryDataItem ItemIndexFullNameDictionary
        {
