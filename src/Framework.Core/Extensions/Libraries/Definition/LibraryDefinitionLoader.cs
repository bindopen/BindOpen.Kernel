...
namespace BindOpen.Framework.Core.Extensions.Libraries.Definition
{
    ...
    public static class LibraryDefinitionLoader
    {
        ...
        public static LibraryDefinition LoadFrom(
            ...
            if (assembly != null)
            {
                ...
                else
                {
                    try
                    {
                        ...
                        {
                            XmlSerializer serializer = new XmlSerializer(typeof(LibraryDefinition));
                            definition = (LibraryDefinition)serializer.Deserialize(stream);
