...
namespace BindOpen.Framework.Core.Extensions.Items.Tasks.Definition.Dto
{
    ...
    [Serializable()]
    [XmlType("TaskDefinition", Namespace = "https://bindopen.org/xsd")]
    [XmlRoot(ElementName = "task.definition", Namespace = "https://bindopen.org/xsd", IsNullable = false)]
    public class TaskDefinitionDto : AppExtensionItemDefinitionDto, ITaskDefinitionDto
    {
        // ------------------------------------------
        // VARIABLES
        // ------------------------------------------
        ...
        /// </summary>
        public TaskDefinitionDto() : this(null, "Task_", null)
        {
        }
        ...
        public TaskDefinitionDto(string name, string preffix, string id) : base(name, preffix, id)
        {
        ...
        public void Repair(ITaskDefinitionDto taskDefinition)
        {
