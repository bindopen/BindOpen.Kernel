...
namespace BindOpen.Framework.Core.Extensions.Items.Tasks
{
    ...
    /// </summary>
    [Serializable()]
    [XmlType("TaskDto", Namespace = "http://meltingsoft.com/bindopen/xsd")]
    [XmlRoot(ElementName = "task", Namespace = "http://meltingsoft.com/bindopen/xsd", IsNullable = false)]
    public class TaskDto
        : TAppExtensionTitledItemDto<TaskDefinition>, ITaskDto
    {
        // ------------------------------------------
        // VARIABLES
        // ------------------------------------------
        ...
        /// <summary>
        /// Instantiates a new instance of the TaskDto class.
        /// </summary>
        public TaskDto() : base()
        {
        }
        ...
        {
            TaskDto task = base.Clone() as TaskDto;
            ...
            string[] specificationAreas = null)
        {
            ...
            if (item is TaskDto configuration)
            {
