...
namespace BindOpen.Framework.Core.Extensions.Items.Routines
{
    ...
    /// </summary>
    [Serializable()]
    [XmlType("RoutineDto", Namespace = "http://meltingsoft.com/bindopen/xsd")]
    [XmlRoot("routine", Namespace = "http://meltingsoft.com/bindopen/xsd", IsNullable = false)]
    public class RoutineDto
        : TAppExtensionTitledItemDto<RoutineDefinition>, IRoutineDto
    {
        //------------------------------------------
        // PROPERTIES
        //-----------------------------------------
        ...
        /// <summary>
        /// Instantiates a new instance of the RoutineDto class.
        /// </summary>
        public RoutineDto() : base()
        {
        }
        ...
        {
            IRoutineDto routine = base.Clone() as RoutineDto;
