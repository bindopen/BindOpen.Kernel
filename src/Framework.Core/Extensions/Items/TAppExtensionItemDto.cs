...
namespace BindOpen.Framework.Core.Extensions.Items
{
    ...
    /// </summary>
    public abstract class TAppExtensionItemDto<T>
        : ConfigurationDto, ITAppExtensionItemDto<T>
        where T : IAppExtensionItemDefinition
    {
        ...
        /// </summary>
        protected TAppExtensionItemDto() : this(AppExtensionItemKind.Any, null)
        {
        }
        ...
        protected TAppExtensionItemDto(
        ...
        {
            ITAppExtensionItemDto<T> appExtensionItem = base.Clone() as TAppExtensionItemDto<T>;
