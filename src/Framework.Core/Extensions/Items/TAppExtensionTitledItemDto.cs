...
namespace BindOpen.Framework.Core.Extensions.Items
{
    ...
    /// </summary>
    public abstract class TAppExtensionTitledItemDto<T>
        : TAppExtensionItemDto<T>, ITAppExtensionTitledItemDto<T>
        where T : IAppExtensionItemDefinition
    {
        ...
        /// </summary>
        protected TAppExtensionTitledItemDto() : this(AppExtensionItemKind.Any, null)
        {
        }
        ...
        protected TAppExtensionTitledItemDto(
        ...
        {
            ITAppExtensionTitledItemDto<T> dto = base.Clone() as TAppExtensionTitledItemDto<T>;
            if (this.Title != null)
