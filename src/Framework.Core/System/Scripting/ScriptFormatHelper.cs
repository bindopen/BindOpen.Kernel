...
namespace BindOpen.Framework.Core.System.Scripting
{
    ...
    /// </summary>
    public static class ScriptFormatHelper
    {
        ...
        public static String Format(String script, int aTabulationNumber=0)
        {
            ...
            {
                index = ScriptParsingHelper.GetIndexOfNextString(aAlignedScript, "(", index + 1);
                ...
                if (index < aAlignedScript.Length)
                {
                    ...
                    {
                        aNextIndex = ScriptParsingHelper.GetIndexOfNextString(aAlignedScript, ",", aNextIndex);
                        ...
                        if (aNextIndex < aAlignedScript.Length)
                        {
                            ...
                            if (aAlignedScript[index] == '(')
                            {
                                ...
                                if (aAlignedScript[aNextIndex] == ',')
                                {
                                    ...
                                    ScriptFormatHelper.AddCRToScript(ref aAlignedScript, index + 1, ref index, ref aNextIndex, aTabulationNumber);
                                ...
                                else
                                {
                                    ...
                                    if ((parameterValue.Contains(ScriptParsingHelper.Symbol_Var) | parameterValue.Contains(ScriptParsingHelper.Symbol_Fun)) &
                            ...
                            String aAlignedSubScript = ScriptFormatHelper.Format(aSubScript.Trim(), aTabulationNumber);
                            ...
                            if (aAlignedScript[aNextIndex] == ',')
                            {
                                ...
                                ScriptFormatHelper.AddCRToScript(ref aAlignedScript, aNextIndex + 1, ref aNextIndex, ref index, aTabulationNumber);
                            ...
                            else if ((aNextIndex <= aAlignedScript.Length - (")." + ScriptParsingHelper.Symbol_Fun).Length) && (aAlignedScript.Substring(aNextIndex, 
                                (")." + ScriptParsingHelper.Symbol_Fun).Length) == ")." + ScriptParsingHelper.Symbol_Fun))
                            {
                                aNextIndex += 3;
                                ...
                                ScriptFormatHelper.AddCRToScript(ref aAlignedScript, aNextIndex, ref index, ref aNextIndex, aTabulationNumber);
                                aNextIndex -= 1;
                                scriptWordDepth += 1;
                            }
