...
namespace BindOpen.Framework.Core.Data.References
{
    ...
    /// </summary>
    public class TItemReference<T> : TBaseItemReference<T>, ITItemReference<T> where T: IDataItem
    {
        // --------------------------------------------------
        // PROPERTIES
        // --------------------------------------------------
        ...
        /// </summary>
        [XmlIgnore()]
        public bool ObjectItemSpecified => !ReferenceSpecified && Item != null;
        ...
        public TItemReference(IDataReference reference)
        {
