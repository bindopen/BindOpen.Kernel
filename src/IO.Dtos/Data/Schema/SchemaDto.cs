...
/// </summary>
[XmlType("Schema", Namespace = "https://storage.bindopen.org/xsd/bindopen/kernel")]
[XmlRoot(ElementName = "schema", Namespace = "https://storage.bindopen.org/xsd/bindopen/kernel", IsNullable = false)]
public class SchemaDto : IBdoDto, IIdentified
{
    // --------------------------------------------------
    // PROPERTIES
    // --------------------------------------------------
    ...
    [XmlElement("rule", Type = typeof(SchemaRuleDto))]
    ...
    [XmlElement("child", Type = typeof(SchemaDto))]
    public List<SchemaDto> Children { get; set; }
    ...
    [XmlElement("item", Type = typeof(SchemaDto))]
