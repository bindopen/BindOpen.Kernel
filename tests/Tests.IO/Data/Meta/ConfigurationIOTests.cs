...
namespace BindOpen.System.Data.Meta
{
    ...
    {
        private readonly string _filePath_xml = SystemData.WorkingFolder + "ConfigurationIO.xml";
        private readonly string _filePath_json = SystemData.WorkingFolder + "ConfigurationIO.json";
        ...
        public void SaveJsonTest()
        {
            ...
            var isSaved = _config.ToDto().SaveJson(_filePath_json);
            Assert.That(isSaved, "Meta list saving failed. ");
        }
        ...
        {
            if (_config == null || !File.Exists(_filePath_json))
            {
                SaveJsonTest();
            }
