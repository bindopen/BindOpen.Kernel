...
{
    public static readonly string XmlFilePath = GlobalTestData.WorkingFolder + "Function.xml";
    public static readonly string JsonFilePath = GlobalTestData.WorkingFolder + "Function.json";
