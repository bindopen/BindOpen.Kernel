...
{
    public static readonly string XmlFilePath = GlobalTestData.WorkingFolder + "Entity.xml";
    public static readonly string JsonFilePath = GlobalTestData.WorkingFolder + "Entity.json";
