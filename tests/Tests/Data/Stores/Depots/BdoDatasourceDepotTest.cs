                ...
                BdoData.NewDatasource(
                    ...
                    BdoData.NewMetaObject("messages$smtp")
                        .With(
                            ...
                            BdoData.NewMetaScalar("port", DataValueTypes.Integer, _testData.port as int?),
                            BdoData.NewMetaScalar("isDefaultCredentialsUsed", DataValueTypes.Boolean, _testData.isDefaultCredentialsUsed as bool?),
                            BdoData.NewMetaScalar("isSslEnabled", DataValueTypes.Boolean, _testData.isSslEnabled as bool?),
                            BdoData.NewMetaScalar("timeout", DataValueTypes.Integer, _testData.timeout as int?),
