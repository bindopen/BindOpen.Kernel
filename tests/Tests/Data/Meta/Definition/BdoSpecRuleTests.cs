...
public class BdoSpecRuleTests
{
    ...
    public void RequirementTest()
    {
        ...
        var requirementLevel0 = meta0.GetRequirementLevel(GlobalTestData.Scope);
        ...
        var requirementLevel1 = meta1.GetRequirementLevel(GlobalTestData.Scope);
        ...
        var requirementLevel2 = meta2.GetRequirementLevel(GlobalTestData.Scope);
    ...
    public void ItemRequirementTest()
    {
        ...
        var requirementLevel0 = meta0.GetItemRequirementLevel(GlobalTestData.Scope);
        ...
        var requirementLevel1 = meta1.GetItemRequirementLevel(GlobalTestData.Scope);
        Assert.That(requirementLevel1 == RequirementLevels.Required, "Statement - Error");
        ...
        var requirementLevel2 = meta2.GetItemRequirementLevel(GlobalTestData.Scope);
        Assert.That(requirementLevel2 == RequirementLevels.Optional, "Statement - Error");
    }
