...
public class BdoConnectorTests
{
    ...
    {
        IBdoMetaObject meta = BdoConnectorFaker.NewMetaObject(_testData);
        var connector = GlobalTestData.Scope.CreateConnector(meta) as ConnectorFake;
    ...
    public void CreateConnectorTest_FromObject()
    {
        ...
        var meta = connector.ToMeta(GlobalTestData.Scope);
        connector = GlobalTestData.Scope.CreateConnector(meta) as ConnectorFake;
