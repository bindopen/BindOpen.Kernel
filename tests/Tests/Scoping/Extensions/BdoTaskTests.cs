...
public class BdoTaskTests
{
    ...
    public void CreateTaskTest_FromMetaSet()
    {
        ...
        var connector = GlobalTestData.Scope.CreateTask<TaskFake>(meta);
    ...
    {
        IBdoMetaObject meta = BdoTaskFaker.NewMetaObject(_testData);
        var connector = GlobalTestData.Scope.CreateTask(meta) as TaskFake;
    ...
    public void CreateTaskTest_FromObject()
    {
        ...
        var config = connector.ToMeta(GlobalTestData.Scope, "testConfig");
        connector = GlobalTestData.Scope.CreateTask(config) as TaskFake;
