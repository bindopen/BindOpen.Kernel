...
//        public static AdvancedDbDataQuery GetTenants(string dataModuleName = "test.db")
//        => new AdvancedDbDataQuery(DbDataQueryKind.Select, dataModuleName, null, null)
//        {
//            Name = "SelectTenants",
//            IsDistinct = true,
...
//        public static DbDataQuery GetTenant(string name, string dataModuleName = "test.db")
...
//        public static DbDataQuery DeleteTenant(string name, string dataModuleName = "test.db")
...
//        public static DbDataQuery UpdateTenant(string name, string dataModuleName = "test.db")
...
//        public static DbDataQuery InsertTenant(string name, string dataModuleName = "test.db")
...
//            {
//                new DbField("Name",
//                    new BasicDbDataQuery(DbDataQueryKind.Select, "test.db", null, "Tenant") {
//                        Top=1,
//                        IdFields =
//                            {
//                                new DbField("Name", DataValueType.Text, name)
